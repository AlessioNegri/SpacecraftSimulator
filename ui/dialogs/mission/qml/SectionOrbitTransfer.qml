...
import "../js/SectionOrbitTransfer.js" as Script

import "../../common"
import "../../../components/material"

// * The SectionOrbitTransfer class manages the orbit transfer section.
ScrollView
{
    ...
    function load()
    {
        __MissionOrbitTransfer.fill_departure_orbit()

        Script.restoreDepartureParameters()

        __MissionOrbitTransfer.fill_arrival_orbit()
            ...
            RowLayout
            {
                ...
                Button
                {
                    ...
                    onClicked:
                    {
                        ...
                        _departureGroundTrackPreview_.open()
                    }
                }
            }
        }
            ...
            RowLayout
            {
                ...
                Button
                {
                    ...
                    onClicked:
                    {
                        ...
                        _arrivalGroundTrackPreview_.open()
                    }
                }
            }
        }
