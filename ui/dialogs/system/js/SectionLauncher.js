...
{   
    ...
    __MissionOrbitInsertion.stage_1.propellant_fraction         = _propellant_fraction_1_.text
    __MissionOrbitInsertion.stage_1.structure_fraction          = _structure_fraction_1_.text
    ...
    __MissionOrbitInsertion.stage_2.propellant_fraction         = _propellant_fraction_2_.text
    __MissionOrbitInsertion.stage_2.structure_fraction          = _structure_fraction_2_.text
    ...
    __MissionOrbitInsertion.stage_3.propellant_fraction         = _propellant_fraction_3_.text
    __MissionOrbitInsertion.stage_3.structure_fraction          = _structure_fraction_3_.text
    ...
    __MissionOrbitInsertion.stage_1.thrust_to_weight_ratio      = _thrust_to_weight_ratio_1_.text
    ...
    __MissionOrbitInsertion.stage_2.thrust_to_weight_ratio      = _thrust_to_weight_ratio_2_.text
    ...
    __MissionOrbitInsertion.stage_3.thrust_to_weight_ratio      = _thrust_to_weight_ratio_3_.text
...
{   
    ...
    _propellant_fraction_1_.text        = __MissionOrbitInsertion.stage_1.propellant_fraction
    _structure_fraction_1_.text         = __MissionOrbitInsertion.stage_1.structure_fraction
    ...
    _propellant_fraction_2_.text        = __MissionOrbitInsertion.stage_2.propellant_fraction
    _structure_fraction_2_.text         = __MissionOrbitInsertion.stage_2.structure_fraction
    ...
    _propellant_fraction_3_.text        = __MissionOrbitInsertion.stage_3.propellant_fraction
    _structure_fraction_3_.text         = __MissionOrbitInsertion.stage_3.structure_fraction
    ...
    _thrust_to_weight_ratio_1_.text     = __MissionOrbitInsertion.stage_1.thrust_to_weight_ratio
    ...
    _thrust_to_weight_ratio_2_.text     = __MissionOrbitInsertion.stage_2.thrust_to_weight_ratio
    ...
    _thrust_to_weight_ratio_3_.text     = __MissionOrbitInsertion.stage_3.thrust_to_weight_ratio
