...
ScrollView
{
    ...
    Component.onCompleted: {
        ...
        __MissionInterplanetaryTransfer.signal_update_progress_bar.connect(Script.updateProgressBar)
        __MissionInterplanetaryTransfer.signal_pork_chop_plot_finished.connect(Script.notifyFinished)
